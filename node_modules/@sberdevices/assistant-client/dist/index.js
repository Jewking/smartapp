...
var createClient = function (clientParams, logger) {
    ...
    var sendVoice = function (data, last, messageId, messageName) {
        if (last === void 0) { last = true; }
        if (messageId === void 0) { messageId = getMessageId(); }
        return send({
            payload: {
    ...
    var batch = function (cb) {
        ...
        var upgradedSendVoice = function (data, last, messageName) {
            checkLastMessageStatus(last);
...
style$1.appendChild(document.createTextNode(RecordPanelStyles));
...
var createVoiceListener = function (createAudioProvider) {
    ...
    var listen = function (handleVoice) {
        status = 'listen';
        createAudioProvider(function (data, last) { return handleVoice(new Uint8Array(data), last); }).then(function (recStop) {
            stopRecord = recStop;
        });
        emit('status', 'listen');
    };
...
var AudioContext$1 = window.AudioContext || window.webkitAudioContext;
...
var createVoicePlayer = function (_a) {
    ...
    var stop = function () {
        ...
        ctx === null || ctx === void 0 ? void 0 : ctx.close();
        ctx = null;
    };
    return {
        append: append,
...
var createMusicRecognizer = function (voiceListener) {
    ...
    var start = function (_a) {
        ...
        status = 'active';
        voiceListener.listen(function (data, last) {
...
var createSpeechRecognizer = function (voiceListener) {
    ...
    var start = function (_a) {
        var sendVoice = _a.sendVoice, messageId = _a.messageId, onMessage = _a.onMessage;
        status = 'active';
        voiceListener.listen(sendVoice);
        off = onMessage(function (message) {
            var _a, _b;
            if (message.status && message.status.code != null && message.status.code < 0) {
                stop();
...
var initializeAssistantSDK = function (_a) {
    ...
    vpsClient.on('systemMessage', function (message, original) {
        ...
        for (var _i = 0, _e = message.items; _i < _e.length; _i++) {
            var item = _e[_i];
            if (item.bubble) {
        ...
        updateDevUI((_d = (_c = message.suggestions) === null || _c === void 0 ? void 0 : _c.buttons) !== null && _d !== void 0 ? _d : [], bubbleText);
    });
...
var createAssistant = function (_a) {
    ...
    window.AssistantClient = {
        onData: function (command) {
            ...
            if (initialData.length) {
                ...
                else if (command.sdkMeta && ((_a = command.sdkMeta) === null || _a === void 0 ? void 0 : _a.mid) !== '-1') {
                    index = initialData.findIndex(function (c) { var _a; return ((_a = c.sdkMeta) === null || _a === void 0 ? void 0 : _a.mid) === command.sdkMeta.mid; });
                }
                if (index >= 0) {
    ...
    return {
        ...
        sendDataAsync: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); }); },
...
export { MessageNames, VpsVersion, createAssistant, createAssistantDev, createAssistantHostMock, createAssistantHostMockWithRecord, createClient, createMusicRecognizer, createOnlineRecordPlayer, createRecordOfflinePlayer as createRecordPlayer, createSmartappDebugger, createSpeechRecognizer, createVoiceListener, createVoicePlayer, initializeAssistantSDK, initializeDebugging };
