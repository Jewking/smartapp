import { AssistantRecord, AssistantAppState, AssistantServerAction, AssistantClientCustomizedCommand, AssistantSmartAppCommand } from './typings';
...
export declare const createAssistantHostMock: ({ context }?: {
    ...
    receiveCommand: <T_1 = AssistantSmartAppCommand>(command: AssistantClientCustomizedCommand<T_1>) => Promise<unknown>;
...
export declare const createAssistantHostMockWithRecord: ({ context, record, }: {
    ...
    receiveCommand: <T = AssistantSmartAppCommand>(command: AssistantClientCustomizedCommand<T>) => Promise<unknown>;
};
