...
export declare const createClient: (clientParams: CreateClientDataType, logger?: ClientLogger | undefined) => {
    ...
    sendVoice: (data: Uint8Array, last?: boolean, messageId?: number, messageName?: string | undefined) => void;
    ...
    batch: <T>(cb: (methods: {
        ...
        sendVoice: (data: Uint8Array, last: boolean, messageName?: string | undefined) => void;
        messageId: number;
    }) => T) => T;
