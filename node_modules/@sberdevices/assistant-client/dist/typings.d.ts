...
export interface AssistantNavigationCommand {
    type: 'navigation';
    navigation: {
        command: 'UP' | 'DOWN' | 'LEFT' | 'RIGHT' | 'BACK' | 'FORWARD';
    };
    sdkMeta?: SdkMeta;
}
...
export declare type AssistantClientCustomizedCommand<T> = AssistantAppContext | AssistantCharacterCommand | AssistantNavigationCommand | AssistantInsetsCommand | AssistantSmartAppError | T;
